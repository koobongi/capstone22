                    ...
                    <div class="row gx-5">
                        <div class="col-xl-8">
                            ...
                            <div class="mb-4">
                                ...
                                <a class="link-dark" href="blog-post.jsp"><h3>Start Bootstrap releases Bootstrap 5 updates for templates and themes</h3></a>
                            </div>
                            <!-- News item-->
                            <div class="mb-5">
                                <div class="small text-muted">2022-05-23</div>
                                <a class="link-dark" href="blog-post.jsp"><h3>Bootstrap 5 has officially landed</h3></a>
                            </div>
                            <!-- News item-->
                            <div class="mb-5">
                                <div class="small text-muted">2022-05-05</div>
                                <a class="link-dark" href="blog-post.jsp"><h3>This is another news article headline, but this one is a little bit longer</h3></a>
                            </div>
                            <div class="text-end mb-5 mb-xl-0">
                                <a class="text-decoration-none" href="faq.jsp">
                                    게시판 바로가기
                                    <i class="bi bi-arrow-right"></i>
                                </a>
                            </div>
                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="bollsite.jsp"><div class="h5 card-title mb-3">구기종목 관련 사이트 추천</div></a>
                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="health.jsp"><div class="h5 card-title mb-3">헬스 관련 사이트 추천</div></a>
                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="portfolio-overview.jsp"><div class="h5 card-title mb-3">건강식품 관련 사이트 추천</div></a>
