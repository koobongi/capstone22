                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-3">
                            <div class="d-flex align-items-center mt-lg-5 mb-4">
                                ...
                                <div class="ms-3">
                                    <div class="fw-bold">구본기</div>
                                    <div class="text-muted">신규 사용자</div>
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="col-lg-9">
                            ...
                            <article>
                                ...
                                <header class="mb-4">
                                    <!-- Post title-->
                                    <h1 class="fw-bolder mb-1">게시판 글 제목1</h1>
                                    <!-- Post meta content-->
                                    <div class="text-muted fst-italic mb-2">2022-05-05</div>
                                    <!-- Post categories-->
