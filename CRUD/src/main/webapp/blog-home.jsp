        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container px-5">
                    ...
                    <!-- <a class="navbar-brand" href="index.html">종합스프초몰</a> -->
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <!-- <li class="nav-item"><a class="nav-link" href="index.html">Home</a></li> -->
                            <!-- <li class="nav-item"><a class="nav-link" href="about.html">종합스포츠몰 소개</a></li> -->
                            <li class="nav-item"><a class="nav-link" href="Login.jsp">로그인</a></li>
                            <!-- <li class="nav-item"><a class="nav-link" href="pricing.html">버리는 페이지</a></li> -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownPortfolio">
                                    ...
                                    <!-- <li><a class="dropdown-item" href="portfolio-item.html">사이트 소개</a></li> -->
                                </ul>
                            </li>
                        </ul>
                    </div>
