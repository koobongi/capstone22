...
<head>
    ...
    <body class="d-flex flex-column h-100">
        <main class="flex-shrink-0"> 
            ...
            <!-- About section one-->
            <div class="container px-5 py-51">
                <div class="col-lg-6">
                </div>
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark1">
                    <div class="container px-5">
                        <a class="navbar-brand col000" href="bollsite.jsp">구기종목</a>
                        <a class="navbar-brand"  href="health.jsp">헬스</a>
                        <a class="navbar-brand" href="portfolio-overview.jsp">건강식품</a>
                        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                    </div>
                </nav>
            </div>
    ...
    <section>
        <div class="container px-5">
            <aside class="bg-dark bg-gradient p-4">
                <div class="d-flex align-items-center justify-content-between flex-column flex-xl-row text-center text-xl-start">
                    <div class="mb-4 mb-xl-0">
                        <div class="fs-3 fw-bold text-white">검색하고 싶은 사이트가 있으신가요?</div>
                        <div class="text-white-50">Is there a site you want to search?</div>
                    </div>
                    <div class="ms-xl-4">
                        <div class="input-group mb-2">
                            <input class="form-control" type="text" placeholder="검색어를 입력하세요" aria-label="Email address..." aria-describedby="button-newsletter" />
                            <button class="btn btn-outline-light" id="button-newsletter" type="button">검색</button>
                        </div>
                        <div class="small text-white-50">정확히 입력하셨나요? (예: 나이키, nike)</div>
                    </div>
                </div>
            </aside>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="position-relative mb-5 mb-lg-0">
                                <p class="boll1">조던</p>
                                <img class="img-fluid rounded-3 mb-3" src="img/조던2.png" alt="..." />
                                <a class="h3 fw-bolder text-decoration-none link-dark stretched-link" href="portfolio-item.jsp"></a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mb-5 mb-lg-0">
                                <p class="boll1">카포풋볼</p>
                                <img class="img-fluid rounded-3 mb-3" src="img/카포.png" alt="..." />
                                <a class="h3 fw-bolder text-decoration-none link-dark stretched-link" href="portfolio-item.jsp"></a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mb-5 mb-lg-0">
                                <p class="boll1">스타스포츠</p>
                                <img class="img-fluid rounded-3 mb-3" src="img/스타스포츠.png" alt="..." />
                                <a class="h3 fw-bolder text-decoration-none link-dark stretched-link" href="portfolio-item.jsp"></a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mb-lg-0">
                                <p class="boll1">나이키</p>
                                <img class="img-fluid rounded-3 mb-3" src="img/나이키.png" alt="..." />
                                <a class="h3 fw-bolder text-decoration-none link-dark stretched-link" href="portfolio-item.jsp"></a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mb-5mb-lg-0">
